function createSymbolicExecutionDiagram(){
  const nodes = [
    {x: 0.50, y: 0.05, type: 'start'},
    {x: 0.35, y: 0.22, type: 'state'},
    {x: 0.65, y: 0.22, type: 'state'},
    {x: 0.20, y: 0.40, type: 'state'},
    {x: 0.45, y: 0.40, type: 'state'},
    {x: 0.55, y: 0.40, type: 'state'},
    {x: 0.80, y: 0.40, type: 'state'},
    {x: 0.12, y: 0.57, type: 'state'},
    {x: 0.28, y: 0.57, type: 'state'},
    {x: 0.38, y: 0.57, type: 'state'},
    {x: 0.52, y: 0.57, type: 'state'},
    {x: 0.62, y: 0.57, type: 'state'},
    {x: 0.72, y: 0.57, type: 'state'},
    {x: 0.88, y: 0.57, type: 'state'},
    {x: 0.08, y: 0.75, type: 'leaf'},
    {x: 0.16, y: 0.75, type: 'bug'},
    {x: 0.24, y: 0.75, type: 'leaf'},
    {x: 0.32, y: 0.75, type: 'leaf'},
    {x: 0.40, y: 0.75, type: 'leaf'},
    {x: 0.48, y: 0.75, type: 'bug'},
    {x: 0.56, y: 0.75, type: 'leaf'},
    {x: 0.64, y: 0.75, type: 'leaf'},
    {x: 0.72, y: 0.75, type: 'leaf'},
    {x: 0.80, y: 0.75, type: 'leaf'},
    {x: 0.88, y: 0.75, type: 'bug'},
    {x: 0.15, y: 0.92, type: 'solver'},
    {x: 0.50, y: 0.92, type: 'solver'},
    {x: 0.85, y: 0.92, type: 'solver'}
  ];
